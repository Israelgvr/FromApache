...
import { Divider, Icon, IconButton, Link, Switch} from "@mui/material";
      ...
      <Boxes pt={0.5} pb={3} px={3}>
        ...
        <Boxes mt={3} lineHeight={1}>
          ...
          >
            ...
            <Boxes sx={{ mx: 1, width: "8rem", minWidth: "8rem" }}>
              <Buttons
                color="dark"
                variant="gradient"
        ...
        <Divider />
        <Boxes display="flex" justifyContent="space-between" alignItems="center" lineHeight={1}>
          <Typography variant="h6">Light / Dark</Typography>

          <Switch checked={darkMode} onChange={handleDarkMode} />
        </Boxes>
        <Divider />
        <Boxes mt={2} textAlign="center">
          <Boxes mb={0.5}>
